...
export default function PanicEventTable() {
  ...
  const emptyRows =
    page > 0 ? Math.max(0, (1 + page) * rowsPerPage - panicEvents.length) : 0;
        ...
        <TableContainer>
          ...
          >
            ...
            <TableBody>
              ...
              {stableSort(panicEvents, getComparator(order, orderBy))
                .slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
                .map((panicEvent, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell
                        ...
                        padding="none"
                      >
                        {panicEvent.conductor}
                      </TableCell>
                      <TableCell align="left">{panicEvent.district}</TableCell>
                      <TableCell align="left">{panicEvent.date.split('T')[0]}</TableCell>
                      {/* <TableCell>
